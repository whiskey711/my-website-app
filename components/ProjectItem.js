...
export default function ProjectItem(props) {
  return (
    <div className="relative flex w-full h-auto justify-center items-center group rounded-lg shadow-xl p-3 bg-stone-200 hover:bg-gradient-to-br from-orange-peel to-phantone-red transition duration-300">
